...
namespace rf
{
    ...
    static auto& key_get = addr_as_ref<Key()>(0x0051F000);
    static auto& key_to_ascii = addr_as_ref<int(int16_t key)>(0x0051EFC0);
    ...
    static auto& mouse_delta_x = addr_as_ref<int>(0x01885464);
    static auto& mouse_delta_y = addr_as_ref<int>(0x01885468);
    static auto& mouse_delta_z = addr_as_ref<int>(0x0188546C);
